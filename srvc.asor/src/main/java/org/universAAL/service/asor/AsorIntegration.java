...
public class AsorIntegration extends ServiceCallee {
	...
	static final String OUTPUT_ENGINE_VERSION = NAMESPACE + "outputEngineVersion";
	static final String OUTPUT_ENGINE_LANG_VER = NAMESPACE + "outputEngineLanguageVersion";
	static final String OUTPUT_ENGINE_MIMETYPES = NAMESPACE + "outputEngineMimeTypes";
	static final String OUTPUT_ENGINE_FILE_EXTENSIONS = NAMESPACE + "outputEngineFileExtensions";
